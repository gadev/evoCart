 ...
 * @internal    @properties &chunk=Чанк товара в корзине;text;evoCartRow&tvs=TV к выводу в корзине;text;img,price,brand&availability=Проверка доступности (tvname или пустое, если не проверять);text;
